...
# "Esto de arriba es en el momento de declarar una variables"
 #if= hola -> Esto marcarría error ya que es un a palabra reservada
...
horas_estudio = 8
nombre = "Patricia"
es_estudiante = True #Se ocupan valores booleano es esto

# Ejemplos incorrectos (líneas comentadas porque marcan error) o de malas prácticas
f = "21 de octubre del 2005"
fechanacimiento = "21 de octubre del 2005"
print()
#class = "Estructuras de Datos"
# 8horas_estudio = 8
Nombre = "P a t r i c i a"
NOMBRE = "PATRICIA"
